...
<head>
    ...
    <title>Ative sua conta - My Invoices</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #666666; font-size: 16px; line-height: 1.6;">
                                Bem-vindo ao <strong>My Invoices</strong>! Estamos felizes em tê-lo conosco.
                            </p>
                            
                            <p style="margin: 0 0 30px 0; color: #666666; font-size: 16px; line-height: 1.6;">
                                Para ativar sua conta e começar a usar nosso sistema, clique no botão abaixo:
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="{{ url('api/v1/activate?token=' . $token) }}" 
                            ...
                            <p style="margin: 10px 0 0 0; padding: 15px; background-color: #f8f8f8; border-radius: 5px; word-break: break-all; font-size: 13px; color: #666666;">
                                {{ url('api/v1/activate?token=' . $token) }}
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f8f8f8; padding: 20px 30px; text-align: center; border-top: 1px solid #e0e0e0;">
                            <p style="margin: 0 0 10px 0; color: #999999; font-size: 12px;">
                                Este link de ativação expirará em 24 horas.
                            </p>
