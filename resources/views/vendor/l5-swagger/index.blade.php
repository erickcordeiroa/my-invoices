...
<head>
    ...
    *:after
    ...
    /* Customizações para layout melhorado */
    .swagger-ui .opblock-body {
        padding: 20px;
    }
    
    /* Estilo para destacar exemplos de requisição/resposta */
    ...
    /* Destaque para seções de exemplo */
    ...
    /* Melhorar visualização de exemplos */
    ...
    /* Destaque para seções de resposta */
    .swagger-ui .response {
        background: #fff;
        border: 1px solid #e5e7eb;
        border-radius: 8px;
    ...
    /* Destaque para código de exemplo */
    ...
    /* Melhorar visualização de schemas */
...
<script>
    window.onload = function() {
        ...
        const ui = SwaggerUIBundle({
            ...
            // Configurações para melhorar exibição de exemplos
            defaultModelsExpandDepth: 1,
            defaultModelExpandDepth: 1,
            displayRequestDuration: {!! config('l5-swagger.defaults.ui.display.display_request_duration', true) ? 'true' : 'false' !!},
            tryItOutEnabled: {!! config('l5-swagger.defaults.ui.display.try_it_out_enabled', true) ? 'true' : 'false' !!},
