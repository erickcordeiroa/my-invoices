...
### 💰 Carteiras (Wallets)
- ✅ **Listagem** (`GET /v1/wallets`)
  - Paginação com cursor
  - Filtro por usuário autenticado

- ✅ **Busca** (`GET /v1/wallets/search`)
  - Busca por nome (parcial)

- ✅ **Detalhes** (`GET /v1/wallets/{id}`)
  - Validação de propriedade

- ✅ **Criação** (`POST /v1/wallets`)
  - Validação de dados
  - Verificação de duplicidade
  - Associação com usuário

- ✅ **Atualização** (`PUT /v1/wallets/{id}`)
  - Validação de propriedade
  - Validação de duplicidade

- ✅ **Exclusão** (`DELETE /v1/wallets/{id}`)
  - Validação de propriedade
...
- ✅ **Rotas** (`routes/api.php`)
  - Rotas de carteiras implementadas
